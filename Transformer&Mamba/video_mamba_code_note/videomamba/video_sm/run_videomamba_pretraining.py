...
def get_args():
    ...
    parser.add_argument('--mask_type', default='tube', choices=[
            'random', 'tube', 'attention', 'random_row', 'tube_row', 
        ],
    ...
    parser.add_argument('--clip_return_attn', default=False, action='store_true',
                        help='whether return CLIP cls_token')
    ...
    parser.add_argument('--clip_return_cls', default=False, action='store_true',
                        help='whether return CLIP cls_token')
...
def main(args):
    ...
    teacher_model = eval(args.clip_teacher)(
        ...
        clip_return_cls=args.clip_return_cls
    )
